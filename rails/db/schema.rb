...
ActiveRecord::Schema[7.0].define(version: 2025_01_15_130255) do
  ...
  create_table "tests", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["admin_id_id"], name: "index_tests_on_admin_id_id"
  end
  ...
  add_foreign_key "tests", "admins", column: "admin_id_id"
end
